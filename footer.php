...
<footer class="foot mdui-text-center<?php if(mdx_get_option("mdx_styles_footer") === "2"){?> mdx-footer-clean<?php }else if(mdx_get_option("mdx_styles_footer") === "3"){?>  mdx-footer-morden<?php }?>">
  ...
  <?php }else if(mdx_get_option("mdx_styles_footer") === "3"){?>
    <div class="mdx-clean-footer">
      ...
      <hr>
      <a href="https://wordpress.org" target="_blank" class="click" rel="nofollow">WordPress</a> << <a href="https://github.com/Cystee/MDx-pp" target="_blank" class="click" rel="nofollow">MDx ++</a> << <a href="https://mdx.flyhigher.top" target="_blank" class="click" rel="nofollow">MDx</a><?php if(!empty(mdx_get_option('mdx_icp_num'))){?><div class="mdx-copyright"><a href="https://beian.miit.gov.cn/" rel="noopener" target="_blank" class="click"><?php echo mdx_get_option('mdx_icp_num');?></a></div><?php }?>
      </div>
  <?php }?>
</footer>
    </div>
